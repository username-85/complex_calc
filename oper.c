...
{
        if (sign == '+')
        	strncpy(lib_name, "lib/libsum.so", buffersize-1);
        else if (sign == '-')
        	strncpy(lib_name, "lib/libdelta.so", buffersize-1);
        else if (sign == '/')
        	strncpy(lib_name, "lib/libdivision.so", buffersize-1);
        else if (sign == '*')
        	strncpy(lib_name, "lib/libmultiplication.so", buffersize-1);
...
{
        if (sign == '+')
        	strncpy(func_name, "sum", buffersize-1);                                                         
        else if (sign == '-')
        	strncpy(func_name, "delta", buffersize-1);
        else if (sign == '/')
        	strncpy(func_name, "division", buffersize-1);
        else if (sign == '*')
        	strncpy(func_name, "multiplication", buffersize-1);
